import { IConfigurationOptions,  IMoviApp,  IServiceManager } from "./abstractions";
...
export class CreateMoviApp implements IMoviApp {
    ...
    public constructor(options?: IMoviApp) {
        ...
        if (this.Configuration) this.Configuration({ Route: ApplicationService.current.RouteManager });
